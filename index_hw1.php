...
<head>
   ...
   <link rel="stylesheet" href="hw/global.css">
   <link rel="stylesheet" href="hw/desktop.css" media="screen and (min-width:960px)">  
   <link rel="stylesheet" href="hw/phone.css" media="screen and (max-width:959px)">  
</head>
<body>
    ...
    <div class="full-width clearfix">
        <div class="fixed-width">
            ...
            <div id="our-story-gallery">
                <div class="gallery"><img src="hw/images/164333447524625_P15622163.jpg"></div>
                <div class="gallery"><img src="hw/images/hdralnin15emw2q6b4z1.jpg"></div>
                <div class="gallery"><img src="hw/images/images.jpg"></div>
                <div class="gallery"><img src="hw/images/kenting.jpg"></div>
            </div>
        </div>
    </div>
...
<!--        <h2>SIMPLE <ins>CRAFT</ins></h2>-->
    ...
    <div class="full-width clearfix">
        ...
        <div class="formdiv">
        <form action="hw/rinfo.php" method="get">
