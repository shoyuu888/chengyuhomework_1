...
<body>
    ...
    <div class="formdiv">
        ...
        <input name="tel" id="tel" pattern='\d{4}[-]\d{6}' placeholder="請輸入格式1234-123456" required><br>
        <label for="password">設定密碼：</label>
        <input type="password" id="password" name="password" placeholder="請填入您的密碼" required><br>
        <label for="birthday">出生日期：</label>
        <input name="birthday" id="birthday" pattern='\d{4}[/]\d{2}[/]\d{2}' placeholder="請輸入格式AAAA/BB/BB" required><br>
